...
package com.mpower.mintel.android.provider;


import com.mpower.mintel.android.application.MIntel;
import com.mpower.mintel.android.database.MIntelSQLiteOpenHelper;
...
public class FormsProvider extends ContentProvider {
    ...
    private static class DatabaseHelper extends MIntelSQLiteOpenHelper {
        ...
        DatabaseHelper(String databasePath, String databaseName) {
    ...
    public Uri insert(Uri uri, ContentValues initialValues) {
        ...
        if (values.containsKey(FormsColumns.FORM_FILE_PATH) == true) {
            ...
            if (values.containsKey(FormsColumns.JRCACHE_FILE_PATH) == false) {
                String cachePath = MIntel.CACHE_PATH + md5 + ".formdef";
            ...
            case FORM_ID:
                ...
                if (update.getCount() > 0) {
                    ...
                    if (values.containsKey(FormsColumns.FORM_FILE_PATH)) {
                        ...
                        values.put(FormsColumns.JRCACHE_FILE_PATH, MIntel.CACHE_PATH + newMd5
                                + ".formdef");
                    }
