...
import com.mpower.mintel.android.listeners.DiskSyncListener;
...
public class DiskSyncTask extends AsyncTask<Void, String, String> {
    ...
    protected String doInBackground(Void... params) {
        ...
        File formDir = new File(MIntel.FORMS_PATH);
                ...
                if (sqlFile.exists()) {
                    ...
                    if (!FileUtils.getMd5Hash(sqlFile).contentEquals(md5)) {
                        ...
                        if (title != null) {
                            ...
                            return MIntel.getInstance().getString(R.string.xform_parse_error,
