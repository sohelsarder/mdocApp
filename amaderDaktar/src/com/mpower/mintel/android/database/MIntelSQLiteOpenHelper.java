...
package com.mpower.mintel.android.database;
...
public abstract class MIntelSQLiteOpenHelper {
    private static final String t = MIntelSQLiteOpenHelper.class.getSimpleName();
     ...
     */
    public MIntelSQLiteOpenHelper(String path, String name, CursorFactory factory, int version) {
        if (version < 1)
