...
package com.mpower.mintel.android.views;
...
import com.mpower.mintel.android.widgets.IBinaryWidget;
import com.mpower.mintel.android.widgets.QuestionWidget;
import com.mpower.mintel.android.widgets.WidgetFactory;
...
public class MIntelView extends ScrollView implements OnLongClickListener {
    ...
    public MIntelView(Context context, FormEntryPrompt questionPrompt, FormEntryCaption[] groups) {
    ...
    public MIntelView(Context context, FormEntryPrompt[] questionPrompts, FormEntryCaption[] groups) {
        super(context);
