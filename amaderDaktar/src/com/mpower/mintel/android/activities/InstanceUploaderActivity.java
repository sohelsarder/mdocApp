...
import com.mpower.mintel.android.listeners.InstanceUploaderListener;
...
import com.mpower.mintel.android.tasks.InstanceUploaderTask;
...
public class InstanceUploaderActivity extends Activity implements
	...
	private ArrayList<Long> completedFiles;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		long[] selectedInstanceIDs = intent
	...
	public void uploadingComplete(HashMap<String, String> result) {
		...
		Cursor results = managedQuery(InstanceColumns.CONTENT_URI, null,
		...
		if (results.getCount() > 0) {
			...
			while (results.moveToNext()) {
				...
				if (isSuccess) {
					//message.append("<h1>" + name
					//		+ "</h1> : <h1>Form Data Sent Successfully.</h1>"
					//		+"\n\n");
			...
			b.setPositiveButton(R.string.ok,
					new DialogInterface.OnClickListener() {
						...
						public void onClick(DialogInterface dialog, int which) {
							...
							Long[] toSendArray = new Long[mInstancesToSend
									.size()];
							mInstancesToSend.toArray(toSendArray);
							mInstanceUploaderTask.execute(toSendArray);
							showDialog(PROGRESS_DIALOG);
