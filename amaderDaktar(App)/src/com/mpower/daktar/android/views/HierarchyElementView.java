...
public class HierarchyElementView extends RelativeLayout {
	...
	public HierarchyElementView(final Context context, final HierarchyElement it) {
		super(context);
		...
		addView(mIcon, new RelativeLayout.LayoutParams(
				android.view.ViewGroup.LayoutParams.WRAP_CONTENT,
				android.view.ViewGroup.LayoutParams.WRAP_CONTENT));

		mPrimaryTextView = new TextView(context);
		mPrimaryTextView.setTextAppearance(context,
		...
		final LayoutParams l = new RelativeLayout.LayoutParams(
				android.view.ViewGroup.LayoutParams.WRAP_CONTENT,
				android.view.ViewGroup.LayoutParams.WRAP_CONTENT);
		...
		mSecondaryTextView.setTextAppearance(context,
	...
	public void showSecondary(final boolean bool) {
		if (bool) {
	...
	public int dipToPx(final int dip) {
