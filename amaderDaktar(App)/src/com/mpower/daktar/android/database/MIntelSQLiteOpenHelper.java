...
package com.mpower.daktar.android.database;
 ...
 * </p>
 */
public abstract class MIntelSQLiteOpenHelper {
	private static final String t = MIntelSQLiteOpenHelper.class
			.getSimpleName();
	 ...
	 */
	public MIntelSQLiteOpenHelper(final String path, final String name,
	...
	public synchronized SQLiteDatabase getWritableDatabase() {
		...
		try {
			...
			if (mName == null) {
				...
				db = SQLiteDatabase.openOrCreateDatabase(mPath + "/" + mName,
						mFactory);
