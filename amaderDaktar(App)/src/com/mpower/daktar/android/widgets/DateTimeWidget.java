...
public class DateTimeWidget extends QuestionWidget {
	...
	public DateTimeWidget(final Context context, final FormEntryPrompt prompt) {
		...
		final String clockType = android.provider.Settings.System.getString(
	...
	private void setAnswer() {
		...
		if (mPrompt.getAnswerValue() != null) {
			...
			final DateTime ldt = new DateTime(
					((Date) ((DateTimeData) mPrompt.getAnswerValue())
							.getValue()).getTime());
