...
public class WidgetFactory {
	 ...
	 *            Android context
	 */
	static public QuestionWidget createWidgetFromPrompt(
			final FormEntryPrompt fep, final Context context) {
		...
		case Constants.CONTROL_INPUT:
			...
			case Constants.DATATYPE_TEXT:
				final String appearance = fep.getAppearanceHint();
				if (appearance != null
						&& appearance.equalsIgnoreCase("numbers")) {
