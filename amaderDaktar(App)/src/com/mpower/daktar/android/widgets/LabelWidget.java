...
/**
 * The Label Widget does not return an answer. The purpose of this widget is to
 * be the top entry in a field-list with a bunch of list widgets below. This
 * widget provides the labels, so that the list widgets can hide their labels
 * and reduce the screen clutter. This class is essentially ListWidget with all
 * the answer generating code removed.
 *
 * @author Jeff Beorse
 */
public class LabelWidget extends QuestionWidget {
	...
	public LabelWidget(final Context context, final FormEntryPrompt prompt) {
