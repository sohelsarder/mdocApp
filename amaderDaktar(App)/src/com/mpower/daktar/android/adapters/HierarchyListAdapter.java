...
import com.mpower.daktar.android.views.HierarchyElementView;
...
public class HierarchyListAdapter extends BaseAdapter {
	...
	public HierarchyListAdapter(final Context context) {
		mContext = context;
	}
	 ...
	 */
	public void setListItems(final List<HierarchyElement> it) {
		mItems = it;
	}
